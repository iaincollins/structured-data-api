...
module.exports = new function() {
  var collectionName = "entities" || process.env.COLLECTION;
  this.collectionName = collectionName;
  
  this.load = function() {
    var promise = new Promise(function(resolve, reject) {
      _loadSchemas(collectionName)
...
function _loadSchemas(collectionName) {
  var promise = new Promise(function(resolve, reject) {
...
function _convertJsonSchemaToModel(jsonSchema, modelName, collectionName) {
  var promise = new Promise(function(resolve, reject) {
    ...
    .then(function(dereferencedJsonSchema) {
      ...
      //console.log(util.inspect(dereferencedJsonSchema, false, null)+"----");
